...
CompileFlags:
  Add:
    ...
    - -I$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/x86_64-linux-android/asm  # Android platform headers
    - -I$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/aarch64-linux-android/asm  # Android platform headers
    - -I$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/arm-linux-androideabi/asm  # Android platform headers
    - -I$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/i686-linux-android/asm  # Android platform headers
    - -I$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/riscv64-linux-android/asm  # Android platform headers
